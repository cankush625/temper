...
- Code style (docstring format, conventions) → [`docs/code-style.md`](docs/code-style.md)
...
## Repository layout
```
docs/      best-practices.md · anti-bluffing.md · review-rubric.md · safety.md · commit-style.md · code-style.md · research/
